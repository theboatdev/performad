...
const JobCard: React.FC<{ job: JobCardProps }> = ({ job }) => {
  return (
    <div className="bg-white rounded-xl shadow-sm border border-primary p-4 sm:p-5 flex flex-col gap-3 relative overflow-hidden hover:shadow-md transition-all duration-200">
      {/* Header */}
      ...
      {/* Decorative Circle */}
      <div className="absolute bottom-0 right-0 w-24 h-24 sm:w-36 sm:h-36 bg-primary/20 rounded-full translate-x-1/3 translate-y-1/3" />
    </div>
  );
};
