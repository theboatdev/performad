      ...
      <div className="max-w-6xl mx-8 md:mx-10 lg:mx-20 xl:mx-auto">
        <div className="transition duration-500 ease-in-out transform scale-100 translate-x-0 translate-y-0 opacity-100">
          <div className="mb-12 space-y-5 md:mb-16 md:text-center">
            <div className="inline-block rounded-lg bg-[#1e293b] bg-opacity-60 px-3 py-1 text-sm font-semibold text-indigo-100 hover:cursor-pointer hover:bg-opacity-40">
              Our Services
            </div>
            <h1 className="text-3xl font-semibold text-gray-100 md:text-5xl">
              Decked with countless Services.
            </h1>
          </div>
        </div>
