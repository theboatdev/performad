...
export default function WhatWeDontDo() {
  const listText1 =
    "We don’t boost posts and call it strategy";
  const listText2 =
    "We don’t run ads without proper tracking";
  const listText3 =
    "We don’t rely on one creative or audience";
  const listText4 =
    "We don’t optimize for vanity metrics";
  const listText5 =
    "We don’t lock brands into rigid, long-term contracts";
