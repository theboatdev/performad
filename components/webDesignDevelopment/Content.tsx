      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10 text-white">
        ...
        <div className="flex-1 text-center lg:text-left">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-5 capitalize">
            Looks like we could be a great fit—let’s start with a simple first step  
          </h1>
          <p className="text-base sm:text-lg lg:text-xl leading-relaxed">
            Start with a free consultation to evaluate your current website or discuss your upcoming project. We’ll provide practical insights and a clear roadmap for building a high-performance digital platform.
          </p>
        </div>
