...
const services: Service[] = [
  { title: "Platform Setup & Migration",CardImage:"/RectangleHero.png", description: "Whether launching a new store or migrating from an existing platform, we ensure a smooth and secure transition. Our team handles data migration, platform configuration, SEO preservation, and performance optimization to minimize disruption and protect your search visibility.",CardSize:"m" },
  { title: "UI/UX & Responsive Design",CardImage:"/RectangleHero.png", description: "A great website experience directly impacts conversion rates. We design intuitive, user-focused interfaces that guide visitors through the buying journey while ensuring seamless performance across desktop, tablet, and mobile devices.",CardSize:"m" },
  { title: "Custom Feature Development",CardImage:"/RectangleHero.png", description: "Every business has unique operational needs. We develop custom functionality tailored to your workflows, from advanced product filtering and checkout features to customer portals and automation tools that enhance user experience.",CardSize:"m" },
  { title: "API & Third-Party Integrations",CardImage:"/RectangleHero.png", description: "Modern businesses rely on connected systems. We integrate your website with essential platforms such as payment gateways, CRMs, inventory systems, shipping tools, marketing platforms, and analytics systems to streamline operations.",CardSize:"l" },
  { title: "Performance & Security Maintenance",CardImage:"/RectangleHero.png", description: "Website performance and security are critical for both user experience and business continuity. We implement continuous monitoring, speed optimization, security hardening, and regular updates to keep your platform running reliably.",CardSize:"l" },
];
