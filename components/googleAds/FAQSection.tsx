...
const FALLBACK_FAQS: FAQ[] = [
  { question: "What Google Ads services does PerfomAd offer?", answer: "We manage end-to-end Google Ads for eCommerce brands, including Search, Shopping, Display, YouTube, Performance Max, Demand Gen, conversion tracking, and landing page optimization." },
  { question: "How do you measure Google Ads success?", answer: "We focus on revenue-driven KPIs such as ROAS, CPA, conversion rate, and profit contribution—not vanity metrics like impressions or clicks." },
  { question: "Do you provide reporting and insights?", answer: "Yes. You receive transparent reports and dashboards with clear insights, performance trends, and actionable recommendations." },
  { question: "How do we get started with PerfomAd?", answer: "Book a free strategy call. We’ll audit your account, identify growth opportunities, and map out a clear execution plan before any commitment" },
];
