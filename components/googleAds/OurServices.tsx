...
const services: Service[] = [
  ...
  { title: "Landing Page Development & Optimization",CardImage:"/googleAds/Google Ads LPD.jpg", description: "Ads don’t fail—landing pages do. We design and optimize landing pages that align with search intent, improve Quality Score, and increase conversion rates across all Google Ads traffic.",CardSize:"m" },
];
