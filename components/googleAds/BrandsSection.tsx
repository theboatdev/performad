...
const featuresWithout = [
  "Manual daily work",
  "Many divisions / silos",
  "Little remarketing",
  "Sales driven approach",
];

const featuresWith = [
  "Set and improved processes",
  "Focus on automation",
  "Integrated team meetings",
  "Cross-network performance",
  "Steering on profit and SQLs",
  "Retention and CLV insights",
    ...
    <div className="relative mt-16 md:mt-32">
      ...
      >
        <h2 className="text-2xl md:text-4xl font-bold mb-1">
          With Us You Will Never Hit Your
        </h2>
